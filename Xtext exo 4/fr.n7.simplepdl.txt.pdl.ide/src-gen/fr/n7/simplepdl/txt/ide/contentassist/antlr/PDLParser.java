...
public class PDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRessourceAccess().getGroup_5_3(), "rule__Ressource__Group_5_3__0");
			builder.put(grammarAccess.getAskedRessourceAccess().getGroup(), "rule__AskedRessource__Group__0");
			...
			builder.put(grammarAccess.getRessourceAccess().getStockAssignment_4(), "rule__Ressource__StockAssignment_4");
			builder.put(grammarAccess.getRessourceAccess().getWorkAssignment_5_2(), "rule__Ressource__WorkAssignment_5_2");
			builder.put(grammarAccess.getRessourceAccess().getWorkAssignment_5_3_1(), "rule__Ressource__WorkAssignment_5_3_1");
			builder.put(grammarAccess.getAskedRessourceAccess().getQuantityAssignment_3(), "rule__AskedRessource__QuantityAssignment_3");
			builder.put(grammarAccess.getAskedRessourceAccess().getRessourceAssignment_5(), "rule__AskedRessource__RessourceAssignment_5");
		}
	}
