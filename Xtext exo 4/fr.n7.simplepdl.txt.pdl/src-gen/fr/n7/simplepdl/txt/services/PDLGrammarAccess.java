...
public class PDLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProcessElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cAskedRessourceParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		
		//ProcessElement returns ProcessElement:
		//    ProcessElement_Impl | WorkDefinition | WorkSequence | Guidance | Ressource | AskedRessource;
		@Override public ParserRule getRule() { return rule; }
		...
		//AskedRessource
		public RuleCall getAskedRessourceParserRuleCall_5() { return cAskedRessourceParserRuleCall_5; }
	}
	...
	public class RessourceElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cStockKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cStockAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cStockEIntParserRuleCall_4_0 = (RuleCall)cStockAssignment_4.eContents().get(0);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cWorkKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_5_1 = (Keyword)cGroup_5.eContents().get(1);
		private final Assignment cWorkAssignment_5_2 = (Assignment)cGroup_5.eContents().get(2);
		private final CrossReference cWorkAskedRessourceCrossReference_5_2_0 = (CrossReference)cWorkAssignment_5_2.eContents().get(0);
		private final RuleCall cWorkAskedRessourceEStringParserRuleCall_5_2_0_1 = (RuleCall)cWorkAskedRessourceCrossReference_5_2_0.eContents().get(1);
		private final Group cGroup_5_3 = (Group)cGroup_5.eContents().get(3);
		private final Keyword cCommaKeyword_5_3_0 = (Keyword)cGroup_5_3.eContents().get(0);
		private final Assignment cWorkAssignment_5_3_1 = (Assignment)cGroup_5_3.eContents().get(1);
		private final CrossReference cWorkAskedRessourceCrossReference_5_3_1_0 = (CrossReference)cWorkAssignment_5_3_1.eContents().get(0);
		private final RuleCall cWorkAskedRessourceEStringParserRuleCall_5_3_1_0_1 = (RuleCall)cWorkAskedRessourceCrossReference_5_3_1_0.eContents().get(1);
		...
		//    '{'
		//        'stock' stock=EInt
		//        ('work' '(' work+=[AskedRessource|EString] ( "," work+=[AskedRessource|EString])* ')' )?
		//    '}';
		@Override public ParserRule getRule() { return rule; }
		...
		//'stock'
		public Keyword getStockKeyword_3() { return cStockKeyword_3; }
		
		//stock=EInt
		public Assignment getStockAssignment_4() { return cStockAssignment_4; }
		
		//EInt
		public RuleCall getStockEIntParserRuleCall_4_0() { return cStockEIntParserRuleCall_4_0; }
		
		//('work' '(' work+=[AskedRessource|EString] ( "," work+=[AskedRessource|EString])* ')' )?
		public Group getGroup_5() { return cGroup_5; }
		
		//'work'
		public Keyword getWorkKeyword_5_0() { return cWorkKeyword_5_0; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_5_1() { return cLeftParenthesisKeyword_5_1; }
		
		//work+=[AskedRessource|EString]
		public Assignment getWorkAssignment_5_2() { return cWorkAssignment_5_2; }
		
		//[AskedRessource|EString]
		public CrossReference getWorkAskedRessourceCrossReference_5_2_0() { return cWorkAskedRessourceCrossReference_5_2_0; }
		
		//EString
		public RuleCall getWorkAskedRessourceEStringParserRuleCall_5_2_0_1() { return cWorkAskedRessourceEStringParserRuleCall_5_2_0_1; }
		...
		//work+=[AskedRessource|EString]
		public Assignment getWorkAssignment_5_3_1() { return cWorkAssignment_5_3_1; }
		
		//[AskedRessource|EString]
		public CrossReference getWorkAskedRessourceCrossReference_5_3_1_0() { return cWorkAskedRessourceCrossReference_5_3_1_0; }
		
		//EString
		public RuleCall getWorkAskedRessourceEStringParserRuleCall_5_3_1_0_1() { return cWorkAskedRessourceEStringParserRuleCall_5_3_1_0_1; }
	...
	public class AskedRessourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.simplepdl.txt.PDL.AskedRessource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cAskedRessourceKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//'AskedRessource'
		public Keyword getAskedRessourceKeyword_0() { return cAskedRessourceKeyword_0; }
	...
	private final AskedRessourceElements pAskedRessource;
	...
	public PDLGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pAskedRessource = new AskedRessourceElements();
	...
	//        'ressource' ressource=[Ressource|EString]
	//    '}';
	public AskedRessourceElements getAskedRessourceAccess() {
		return pAskedRessource;
	}
	
	public ParserRule getAskedRessourceRule() {
		return getAskedRessourceAccess().getRule();
	}
