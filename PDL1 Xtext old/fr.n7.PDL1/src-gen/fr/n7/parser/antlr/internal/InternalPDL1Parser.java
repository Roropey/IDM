...
public class InternalPDL1Parser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'process'", "'{'", "'}'", "'wd'", "'ws'", "'from'", "'to'", "'note'", "'s2s'", "'f2f'", "'s2f'", "'f2s'"
    };
    ...
    public final EObject ruleWorkSequence() throws RecognitionException {
        ...
        try {
            ...
            otherlv_3=(Token)match(input,RULE_ID,FOLLOW_8); 
            					...
            					newLeafNode(otherlv_3, grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionCrossReference_3_0());
    ...
    // InternalPDL1.g:336:1: ruleWorkSequenceType returns [Enumerator current=null] : ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2f' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2s' ) ) ;
    public final Enumerator ruleWorkSequenceType() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:342:2: ( ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2f' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2s' ) ) )
            // InternalPDL1.g:343:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2f' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2s' ) )
            {
            // InternalPDL1.g:343:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2f' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2s' ) )
            int alt3=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalPDL1.g:352:3: (enumLiteral_1= 'f2f' )
                    {
                    // InternalPDL1.g:352:3: (enumLiteral_1= 'f2f' )
                    // InternalPDL1.g:353:4: enumLiteral_1= 'f2f'
                    {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalPDL1.g:368:3: (enumLiteral_3= 'f2s' )
                    {
                    // InternalPDL1.g:368:3: (enumLiteral_3= 'f2s' )
                    // InternalPDL1.g:369:4: enumLiteral_3= 'f2s'
                    {
