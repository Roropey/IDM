...
public class InternalPDL1Parser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'s2s'", "'f2f'", "'s2f'", "'f2s'", "'process'", "'{'", "'}'", "'wd'", "'ws'", "'from'", "'to'", "'note'"
    };
    ...
    // InternalPDL1.g:220:1: rule__WorkSequenceType__Alternatives : ( ( ( 's2s' ) ) | ( ( 'f2f' ) ) | ( ( 's2f' ) ) | ( ( 'f2s' ) ) );
    public final void rule__WorkSequenceType__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:224:1: ( ( ( 's2s' ) ) | ( ( 'f2f' ) ) | ( ( 's2f' ) ) | ( ( 'f2s' ) ) )
            int alt2=4;
            switch ( input.LA(1) ) {
            case 11:
                {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalPDL1.g:231:2: ( ( 'f2f' ) )
                    {
                    // InternalPDL1.g:231:2: ( ( 'f2f' ) )
                    // InternalPDL1.g:232:3: ( 'f2f' )
                    {
                     before(grammarAccess.getWorkSequenceTypeAccess().getFinishToFinishEnumLiteralDeclaration_1()); 
                    // InternalPDL1.g:233:3: ( 'f2f' )
                    // InternalPDL1.g:233:4: 'f2f'
                    {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalPDL1.g:243:2: ( ( 'f2s' ) )
                    {
                    // InternalPDL1.g:243:2: ( ( 'f2s' ) )
                    // InternalPDL1.g:244:3: ( 'f2s' )
                    {
                     before(grammarAccess.getWorkSequenceTypeAccess().getFinishToStartEnumLiteralDeclaration_3()); 
                    // InternalPDL1.g:245:3: ( 'f2s' )
                    // InternalPDL1.g:245:4: 'f2s'
                    {
    ...
    // InternalPDL1.g:535:1: rule__WorkSequence__Group__3__Impl : ( ( rule__WorkSequence__PredecesorAssignment_3 ) ) ;
    public final void rule__WorkSequence__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:539:1: ( ( ( rule__WorkSequence__PredecesorAssignment_3 ) ) )
            // InternalPDL1.g:540:1: ( ( rule__WorkSequence__PredecesorAssignment_3 ) )
            {
            // InternalPDL1.g:540:1: ( ( rule__WorkSequence__PredecesorAssignment_3 ) )
            // InternalPDL1.g:541:2: ( rule__WorkSequence__PredecesorAssignment_3 )
            {
             before(grammarAccess.getWorkSequenceAccess().getPredecesorAssignment_3()); 
            // InternalPDL1.g:542:2: ( rule__WorkSequence__PredecesorAssignment_3 )
            // InternalPDL1.g:542:3: rule__WorkSequence__PredecesorAssignment_3
            {
            pushFollow(FOLLOW_2);
            rule__WorkSequence__PredecesorAssignment_3();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getWorkSequenceAccess().getPredecesorAssignment_3()); 
    ...
    // $ANTLR start "rule__WorkSequence__PredecesorAssignment_3"
    // InternalPDL1.g:718:1: rule__WorkSequence__PredecesorAssignment_3 : ( ( RULE_ID ) ) ;
    public final void rule__WorkSequence__PredecesorAssignment_3() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionCrossReference_3_0()); 
            // InternalPDL1.g:725:3: ( RULE_ID )
            // InternalPDL1.g:726:4: RULE_ID
            {
             before(grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionIDTerminalRuleCall_3_0_1()); 
            match(input,RULE_ID,FOLLOW_2); 
             after(grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionIDTerminalRuleCall_3_0_1()); 

            }

             after(grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionCrossReference_3_0()); 
    ...
    // $ANTLR end "rule__WorkSequence__PredecesorAssignment_3"
