...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class WorkSequenceElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cPredecesorAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cPredecesorWorkDefinitionCrossReference_3_0 = (CrossReference)cPredecesorAssignment_3.eContents().get(0);
		private final RuleCall cPredecesorWorkDefinitionIDTerminalRuleCall_3_0_1 = (RuleCall)cPredecesorWorkDefinitionCrossReference_3_0.eContents().get(1);
		...
		public Assignment getPredecesorAssignment_3() { return cPredecesorAssignment_3; }
		
		//[WorkDefinition]
		public CrossReference getPredecesorWorkDefinitionCrossReference_3_0() { return cPredecesorWorkDefinitionCrossReference_3_0; }
		
		//ID
		public RuleCall getPredecesorWorkDefinitionIDTerminalRuleCall_3_0_1() { return cPredecesorWorkDefinitionIDTerminalRuleCall_3_0_1; }
