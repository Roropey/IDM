 ...
 *   <li>{@link fr.n7.pDL1.impl.WorkSequenceImpl#getPredecesor <em>Predecesor</em>}</li>
...
public class WorkSequenceImpl extends ProcessElementImpl implements WorkSequence
{
  ...
  public WorkDefinition getPredecesor()
  {
    if (predecesor != null && predecesor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDL1Package.WORK_SEQUENCE__PREDECESOR, oldPredecesor, predecesor));
      }
    }
    return predecesor;
  }
  ...
  public void setPredecesor(WorkDefinition newPredecesor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL1Package.WORK_SEQUENCE__PREDECESOR, oldPredecesor, predecesor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDL1Package.WORK_SEQUENCE__LINK_TYPE:
        return getLinkType();
      case PDL1Package.WORK_SEQUENCE__PREDECESOR:
