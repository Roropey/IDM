...
public interface PDL1Package extends EPackage
{
   ...
   * @ordered
   */
  int WORK_SEQUENCE__PREDECESOR = PROCESS_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.WorkSequence#getPredecesor <em>Predecesor</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Predecesor</em>'.
   * @see fr.n7.pDL1.WorkSequence#getPredecesor()
   * @see #getWorkSequence()
   * @generated
   */
  EReference getWorkSequence_Predecesor();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference WORK_SEQUENCE__PREDECESOR = eINSTANCE.getWorkSequence_Predecesor();
