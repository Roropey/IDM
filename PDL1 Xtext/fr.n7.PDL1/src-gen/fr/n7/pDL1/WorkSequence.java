 ...
 *   <li>{@link fr.n7.pDL1.WorkSequence#getPredecesor <em>Predecesor</em>}</li>
...
public interface WorkSequence extends ProcessElement
{
   ...
   * @see #setPredecesor(WorkDefinition)
   * @see fr.n7.pDL1.PDL1Package#getWorkSequence_Predecesor()
   * @model
   * @generated
   */
  WorkDefinition getPredecesor();

  /**
   * Sets the value of the '{@link fr.n7.pDL1.WorkSequence#getPredecesor <em>Predecesor</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setPredecesor(WorkDefinition value);
