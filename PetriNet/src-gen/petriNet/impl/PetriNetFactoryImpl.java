...
public class PetriNetFactoryImpl extends EFactoryImpl implements PetriNetFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case PetriNetPackage.ARC_SENS:
			return createArcSensFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case PetriNetPackage.ARC_SENS:
			return convertArcSensToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ArcSens createArcSensFromString(EDataType eDataType, String initialValue) {
		ArcSens result = ArcSens.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public String convertArcSensToString(EDataType eDataType, Object instanceValue) {
