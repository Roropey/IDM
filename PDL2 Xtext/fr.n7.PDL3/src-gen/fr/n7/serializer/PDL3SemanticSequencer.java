...
public class PDL3SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (predecesor=[WorkDefinition|ID] linkType=WorkSequenceType successor=[WorkDefinition|ID])
	 * </pre>
	 */
	protected void sequence_WorkSequence(ISerializationContext context, WorkSequence semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL3Package.Literals.WORK_SEQUENCE__PREDECESOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL3Package.Literals.WORK_SEQUENCE__PREDECESOR));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWorkSequenceAccess().getPredecesorWorkDefinitionIDTerminalRuleCall_0_0_1(), semanticObject.eGet(PDL3Package.Literals.WORK_SEQUENCE__PREDECESOR, false));
