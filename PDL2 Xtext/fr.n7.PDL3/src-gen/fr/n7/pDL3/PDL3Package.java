...
public interface PDL3Package extends EPackage
{
   ...
   * @ordered
   */
  int WORK_SEQUENCE__PREDECESOR = 0;
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL3.WorkSequence#getPredecesor <em>Predecesor</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Predecesor</em>'.
   * @see fr.n7.pDL3.WorkSequence#getPredecesor()
   * @see #getWorkSequence()
   * @generated
   */
