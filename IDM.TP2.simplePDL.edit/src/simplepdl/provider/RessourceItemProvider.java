		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_work_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_work_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__WORK,
				 true,
				 false,
				 true,
				 null,
